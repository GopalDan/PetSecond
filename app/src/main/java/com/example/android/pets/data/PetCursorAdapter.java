...
public class PetCursorAdapter extends CursorAdapter {
     ...
     * @param view  The parent to which the new view is attached to
    ...
    public View newView(Context context, Cursor cursor, ViewGroup view) {
        ...
        return LayoutInflater.from(context).inflate(R.layout.list_item, view , false);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView petBreedView = (TextView) view.findViewById(R.id.summary);
        ...
        petBreedView.setText(String.valueOf(petBreed));
