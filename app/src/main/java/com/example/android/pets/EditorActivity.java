...
// the view, and we change the mPetHasChanged boolean to true.
    ...
    private void savePet() {
        ...
        // Updating
            ...
            if (rowsUpdated == 0) {
                Toast.makeText(this, "Updationtion Unsuccessful", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "Updationtion Successful", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        // mGenderSpinner.setText(mGender);
